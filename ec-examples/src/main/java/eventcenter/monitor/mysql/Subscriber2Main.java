...
public class Subscriber2Main {
	...
	public static void main(String[] args) {
		...
		System.setProperty(AppDataContext.SYSTEM_PROPERTY_PATH, "." + File.separator + "target" + File.separator + "monitor" + File.separator + "sub2");
		new ClassPathXmlApplicationContext("/spring/monitor/mysql/spring-ec-subscriber2.xml");
