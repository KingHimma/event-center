package eventcenter.remote.saf.leveldb.listeners;
...
public class MultiSubscribEventListener implements EventListener {
	...
	public void onObserved(CommonEventSource source) {
		...
		System.out.println(DateUtils.getNowDate() + this.getClass() + "消费了事件: " + evt.getEventName() /*获取事件名称*/ + "，参数：" + data1 + "_" + data2 + "_" + result + "_" + evt.getEventId());
	}
